                ...
                <div className=" px-6 py-12 mx-auto">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        <div className="sm:col-span-2">
                            <h1 className="max-w-lg text-2xl tracking-tight text-gray-800 xl:text-3xl dark:text-white font-[Oswald]">Subscribe our newsletter to get update.</h1>

                            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                                <input id="email" type="text" className="border-[2px] p-3 rounded-none focus:outline-0 focus:border-primary" placeholder="Email Address"/>

                                    <button className="bg-gradient-to-r from-indigo-500 via-purple-500 to-purple-500 hover:bg-gradient-to-r hover:from-indigo-600 hover:via-purple-600 hover:to-purple-600 rounded-r-md text-white mt-6 px-7 pt-3 pb-2 text-lg font-[Heebo] uppercase duration-500 hover:scale-[1.06]">
                                        Subscribe
                                    </button>
                            </div>
                        </div>
                    ...
                    <hr className="my-6 border-gray-200 md:my-8 dark:border-gray-700"/>
                        ...
                        <div className="flex items-center justify-between">
                            <Link to="#">
                               <h1 className='font-[Heebo] font-semibold text-2xl'>VideoScript</h1>
                            </Link>
