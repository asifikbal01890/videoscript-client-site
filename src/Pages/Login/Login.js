...
const Login = () => {
    ...
    return (
        <div className="relative min-h-screen flex md:ml-6 ml-16 mr-4 border-b">
            <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
                <div className="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative bg-"
                    ...
                    <div className="w-full  max-w-md z-10">
                        <div className="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Sign In to Our More Feature </div>
                        <div className="sm:text-sm xl:text-md text-gray-200 font-normal">Sign in to our user-friendly video to text converter and enjoy the benefits of accurate and efficient transcriptions. Our platform uses advanced technology to transcribe your videos quickly and accurately, saving you time and effort. Plus, our sign-in page is secure and easy to navigate, ensuring that your content is protected at all times.</div>
                    </div>
                    {/* ----remove custom style--- */}
                ...
                <div className="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
                    <div className="max-w-md w-full space-y-8">
                        ...
                        <form onSubmit={handleSubmit} className="mt-8 space-y-6" action="#" method="POST">
                            ...
                            <div>
                                <button type="submit"
                                    className="w-full uppercase flex justify-center bg-gradient-to-r from-indigo-500 to-blue-600  hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600 text-gray-100 p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                                    Sign in
                                </button>
                            </div>
